...
import Timeline_Bildung from '../components/timeline-bildung/'
    ...
    <Layout location={location}>
      ...
      <Wrapper className={className} >
        <Container className="page-content" fluid>
          ...
          <Row>
            <Col xs={4} sm={4}>
              <About title='Über mich' text={siteConfig.authorDescription}/>
            </Col>
            <Col xs={4} sm={4}>
              <Skills title='Fähigkeiten' skills={siteConfig.skills} />
            </Col>
          </Row>
          <Separator />
          <Timeline />
